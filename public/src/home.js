...
function getBooksBorrowedCount(books) {
  ...
  let allBorrows = books.map(book => book.borrows).flat();
  let unreturnedBooks = allBorrows.filter(borrowed => borrowed.returned === false);
  
  let totalBorrowedBooks = unreturnedBooks.length;
